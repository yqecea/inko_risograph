...
const Comparison: React.FC = () => {
  return (
    <section className="py-24 md:py-48 bg-[#f4f1ea] relative">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Ledger Table */}
          <div className="relative border-4 border-[#1a1a1a] bg-white overflow-hidden overflow-x-auto">
            {/* Top Bar */}
            <div className="bg-[#1a1a1a] text-[#f4f1ea] px-6 py-3 flex justify-between items-center text-[10px] uppercase font-bold tracking-widest">
            ...
            <table className="w-full border-collapse min-w-[600px]">
              <thead>
                <tr className="border-b-4 border-[#1a1a1a]">
                  <th className="p-6 text-left font-syne font-bold uppercase text-xs border-r-4 border-[#1a1a1a]">Feature Variable</th>
                  <th className="p-6 text-center font-syne font-bold uppercase text-xs border-r-4 border-[#1a1a1a] bg-gray-50">Standard SaaS</th>
              ...
              <tbody className="text-sm font-medium">
                <tr className="border-b-2 border-gray-200 group hover:bg-gray-50">
                  <td className="p-6 border-r-4 border-[#1a1a1a] font-syne uppercase tracking-tight">Latency Response</td>
                  <td className="p-6 text-center border-r-4 border-[#1a1a1a] text-gray-400">120ms (Delayed)</td>
                  <td className="p-6 text-center font-bold text-riso-blue">14ms (Instant Press)</td>
                </tr>
                <tr className="border-b-2 border-gray-200 group hover:bg-gray-50">
                  <td className="p-6 border-r-4 border-[#1a1a1a] font-syne uppercase tracking-tight">Visual Integrity</td>
                  <td className="p-6 text-center border-r-4 border-[#1a1a1a] text-gray-400">Compressed / Flat</td>
                  <td className="p-6 text-center font-bold text-riso-pink">Tactile / Layered</td>
                </tr>
                <tr className="border-b-2 border-gray-200 group hover:bg-gray-50">
                  <td className="p-6 border-r-4 border-[#1a1a1a] font-syne uppercase tracking-tight">Export Fidelity</td>
                  <td className="p-6 text-center border-r-4 border-[#1a1a1a] text-gray-400">Low-res PNG</td>
                  <td className="p-6 text-center font-bold text-riso-green">Print-Ready Vector</td>
                </tr>
                <tr className="border-b-2 border-gray-200 group hover:bg-gray-50">
                  <td className="p-6 border-r-4 border-[#1a1a1a] font-syne uppercase tracking-tight">API Reliability</td>
                  <td className="p-6 text-center border-r-4 border-[#1a1a1a] text-gray-400">Standard 99.0%</td>
                  <td className="p-6 text-center font-bold text-riso-yellow">Ironclad 99.99%</td>
                </tr>
                <tr className="group hover:bg-gray-50">
                  <td className="p-6 border-r-4 border-[#1a1a1a] font-syne uppercase tracking-tight">Soul Coefficient</td>
                  <td className="p-6 text-center border-r-4 border-[#1a1a1a] text-gray-400">0.0 (Mechanical)</td>
            ...
            <div className="absolute top-1/2 -right-12 w-48 h-12 bg-riso-yellow/30 rotate-90 items-center justify-center text-[10px] font-bold uppercase tracking-widest text-[#1a1a1a] hidden md:flex">
